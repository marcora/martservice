  ...
  def create_static_json_files
    ...
    self.marts().each_with_index { |mart, index|
      ...
      self.datasets(mart[:name]).each { |dataset|
        datasets << dataset
        marts_and_datasets[index][:menu] << dataset.merge!({ :text => dataset[:display_name] || dataset[:name], :iconCls => 'dataset_icon', :menu => [{ :text => 'Simple', :iconCls => 'interface_icon', :itemId => 'simple', :interface_name => 'simple', :interface_display_name => 'Simple', :mart_name => mart[:name], :mart_display_name => mart[:display_name], :dataset_name => dataset[:name], :dataset_display_name => dataset[:display_name] },{ :text => 'Guided', :iconCls => 'interface_icon', :itemId => 'guided', :interface_name => 'guided', :interface_display_name => 'Guided', :mart_name => mart[:name], :mart_display_name => mart[:display_name], :dataset_name => dataset[:name], :dataset_display_name => dataset[:display_name] },{ :text => 'Advanced', :iconCls => 'interface_icon', :itemId => 'advanced', :interface_name => 'advanced', :interface_display_name => 'Advanced', :mart_name => mart[:name], :mart_display_name => mart[:display_name], :dataset_name => dataset[:name], :dataset_display_name => dataset[:display_name] }] })
